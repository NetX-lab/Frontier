...
class PrefillSyncCollectiveEvent(BaseEvent):
    """Event to handle collective synchronization for MoE prefill path."""
    ...
    def __init__(
        ...
        super().__init__(time, EventType.PREFILL_SYNC_COLLECTIVE)
    ...
    def handle_event(
        ...
        return cluster_scheduler.on_prefill_sync_collective(
            self.time,
            self._replica_id,
            self._stage_id,
