"""CLI for profiling Qwen3.5 gated-delta-network layers with vLLM."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--profile-method", default="device_event")
...
def build_profile_inputs(args: argparse.Namespace) -> list[GDNProfileInput]:
    inputs = [
        ...
        for batch_size in args.prefill_batch_sizes
