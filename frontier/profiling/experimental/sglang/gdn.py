...
def gdn_core_spec(model, tp):
    ...
    # Frontier's simulator layout is (kernel-1, channels); the packed SGLang
    # kernel consumes the equivalent transposed view (channels, kernel-1).
    runtime_conv_shape = (layout.conv_state_shape[1], layout.conv_state_shape[0])
    return {
        ...
        "conv_state_shape": runtime_conv_shape,
