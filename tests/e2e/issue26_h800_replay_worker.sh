...
bash "$WORKERS/issue26_h800_uniform_groundtruth_worker.sh" "$REPLAY_ROOT/clean"
bash "$WORKERS/issue26_h800_diagnostics_worker.sh" "$REPLAY_ROOT/batch/runtime" batch
