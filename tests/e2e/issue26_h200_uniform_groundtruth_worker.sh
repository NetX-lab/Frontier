...
source "$(dirname "$0")/issue26_h200_environment_probe.sh" "$UNIFORM_RUN_ROOT/uniform-preflight"
...
PY
bash "$REPO_ROOT/tests/e2e/issue26_h200_official_ttft_worker.sh" "$UNIFORM_RUN_ROOT/runtime"
