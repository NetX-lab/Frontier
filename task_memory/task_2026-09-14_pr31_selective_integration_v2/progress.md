...
| 2026-09-15 | Added explicit single-layer ownership transfer for `copy_components=False` and routed dense/MoE predictor single-layer results through it; predictor/stage regression passed 93 tests. Performance remeasurement is pending. |
