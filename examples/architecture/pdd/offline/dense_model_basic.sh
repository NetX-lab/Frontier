#!/bin/bash
# =============================================================================
# PDD / pd-disaggregation Offline Mode - Dense Model Example
# =============================================================================
...
#
# This script demonstrates the release-supported sequential pd-disaggregation path.
# Decode CUDA Graph modeling and Chunked Prefill can be toggled with
# DECODE_CUDA_GRAPH_MODE and ENABLE_CHUNKED_PREFILL.
...
RUN_ID="${RUN_ID:-dense_model_basic}"
...
cat <<EOF
=========================================================
  PDD / pd-disaggregation Mode - Dense Model Example
=========================================================
