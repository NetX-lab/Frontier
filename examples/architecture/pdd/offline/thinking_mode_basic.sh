#!/bin/bash
# =============================================================================
# PDD / pd-disaggregation Offline Mode - Dense Thinking Mode Example
# =============================================================================
...
#
# This script demonstrates Thinking Mode on the release-supported sequential
...
RUN_ID="${RUN_ID:-thinking_mode_basic}"
...
cat <<EOF
=========================================================
  PDD / pd-disaggregation Mode - Dense Thinking Mode Example
=========================================================
