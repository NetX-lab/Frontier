#!/bin/bash
# =============================================================================
# Co-location (Monolithic) Online Mode - MoE Speculative Decoding / MTP Recipe
# =============================================================================
# This advanced recipe starts from the basic MoE co-location shape and enables
# speculative decoding. Frontier currently forbids speculative decoding together
# with decode CUDA Graph modeling in normal user-facing runs, so this recipe
# intentionally defaults DECODE_CUDA_GRAPH_MODE to "none" and does not use the
# diagnostic override.
#
# For MTP-style methods, set SPEC_METHOD to one of the supported MTP methods and
# keep MTP_N_PREDICT / MTP_NUM_LAYERS positive.
# Example:
#   SPEC_METHOD=qwen3_next_mtp MTP_N_PREDICT=2 MTP_NUM_LAYERS=1 bash examples/architecture/co-location/online/moe_spec_dec_online.sh
# =============================================================================
...
PROPOSER_OVERHEAD_MS_BY_METHOD="${PROPOSER_OVERHEAD_MS_BY_METHOD:-{\"ngram\":0.0,\"qwen3_next_mtp\":0.0,\"deepseek_mtp\":0.0}}"
...
RUN_ID="${RUN_ID:-moe_spec_dec_online}"
