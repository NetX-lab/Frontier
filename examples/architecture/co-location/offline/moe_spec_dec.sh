#!/bin/bash
# =============================================================================
# Co-location (Monolithic) Mode - MoE Speculative Decoding / MTP Recipe
# =============================================================================
...
# Example:
#   SPEC_METHOD=qwen3_next_mtp MTP_N_PREDICT=2 MTP_NUM_LAYERS=1 bash examples/architecture/co-location/offline/moe_spec_dec.sh
# =============================================================================
