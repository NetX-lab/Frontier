#!/bin/bash
# =============================================================================
# Co-location (Monolithic) Mode - Dense Model Example
# =============================================================================
...
# Example:
#   NUM_REQUESTS=4 DECODE_TOKENS=16 bash examples/architecture/co-location/dense_model_basic.sh -- --metrics_config_run_id custom_dense
# =============================================================================
