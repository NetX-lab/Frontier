#!/bin/bash
# Run the sequential PD-AF online baseline with dense-safe defaults.
...
export EXAMPLE_LABEL="${EXAMPLE_LABEL:-Dense Basic Online}"
export RUN_ID="${RUN_ID:-dense_model_basic_online}"
