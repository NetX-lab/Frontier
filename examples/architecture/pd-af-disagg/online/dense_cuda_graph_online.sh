#!/bin/bash
# Run the sequential PD-AF online dense CUDA Graph example.
...
export EXAMPLE_LABEL="${EXAMPLE_LABEL:-Dense CUDA Graph Online}"
export RUN_ID="${RUN_ID:-dense_cuda_graph_online}"
