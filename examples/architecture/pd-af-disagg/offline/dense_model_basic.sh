#!/bin/bash
# Run the sequential PD-AF offline baseline with dense-safe defaults.
...
export EXAMPLE_LABEL="${EXAMPLE_LABEL:-Dense Basic}"
export RUN_ID="${RUN_ID:-dense_model_basic}"
