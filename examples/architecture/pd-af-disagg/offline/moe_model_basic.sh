#!/bin/bash
# =============================================================================
# PD-AF / pd-af-disaggregation Offline Mode - MoE Model Basic Example
# =============================================================================
...
EXAMPLE_LABEL="${EXAMPLE_LABEL:-MoE Basic (EP=1)}"
...
Model topology: total_experts=$TOTAL_EXPERTS, router_topk=$ROUTER_TOPK, routing=$MOE_ROUTING_DISTRIBUTION_TYPE
